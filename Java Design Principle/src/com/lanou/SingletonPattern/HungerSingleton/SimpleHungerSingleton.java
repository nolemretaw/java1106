package com.lanou.SingletonPattern.HungerSingleton;

/**
 * @Author: HuTingrong
 * @Description:
 * @Date: Created in 10:50 2019/10/31
 * @Modified By:
 *
 * 是否 Lazy 初始化：否
 *
...
public class SimpleHungerSingleton {
    //每次加载此类就创建
    private static SimpleHungerSingleton instance = new SimpleHungerSingleton();
